...
pub struct Level {
    ...
    pub iid: String,
    pub size: Size,
    pub ldtk_position: LdtkPosition,
...
impl Level {
    pub fn from_instance(
        ...
        Level {
            ...
            size: Size::new(
                (instance.px_wid / project.default_grid_size) as u32,
                (instance.px_hei / project.default_grid_size) as u32,
                project.default_grid_size as u32,
            ),
            ldtk_position: LdtkPosition::from_level_instance(instance, project),
            tile_layers,
            entity_layers,
            int_grid_layers,
            auto_layers,
